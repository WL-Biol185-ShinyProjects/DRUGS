...
##Deleting "reviews" from Review to make it numeric
```{r}
...
Filtered_UnduplicatedDrug1 <- filter(UnduplicatedDrug1, Condition == 'Acute Bacterial Sinusitis')
  ggplot( Filtered_UnduplicatedDrug1, aes(Drug, Satisfaction)) + geom_bar(stat = 'identity') + theme(axis.text.x = element_text(angle = 45, hjust = 1)) 
```
