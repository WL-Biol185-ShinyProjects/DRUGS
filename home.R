...
home <- tabPanel(
  ...
  p("While Drug Squad provides comprehensive and reliable drug information, it is important to remember that this app is designed for informational purposes only. Always consult your doctor or healthcare provider before making any decisions about your medications or treatment. Your doctor knows your medical history best and can provide personalized advice tailored to your needs."),

  # Adding image to home
img(src="publicDrugImage.jpg", height="100%", width="100%", align = "center"),
